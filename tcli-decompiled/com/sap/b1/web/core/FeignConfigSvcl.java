 ...
 *  com.sap.b1.svcl.client.ServiceLayerBatchClient
 *  com.sap.b1.svcl.client.ServiceLayerClient
 *  com.sap.b1.svcl.client.ServiceLayerFormClient
 ...
 *  com.sap.b1.svcl.feign.internal.service.AttachmentInternalService
 *  com.sap.b1.svcl.feign.internal.service.BatchInternalService
 *  com.sap.b1.svcl.feign.internal.service.InventoryQueryService
 *  com.sap.b1.svcl.feign.internal.service.UserDefinedObjectInternalService
 *  com.sap.b1.util.HttpClientPoolUtil
 *  com.sap.b1.web.core.FeignConfigSvcl
...
import com.sap.b1.svcl.client.ServiceLayerBatchClient;
import com.sap.b1.svcl.client.ServiceLayerClient;
import com.sap.b1.svcl.client.ServiceLayerFormClient;
...
import com.sap.b1.svcl.feign.internal.service.AttachmentInternalService;
import com.sap.b1.svcl.feign.internal.service.BatchInternalService;
import com.sap.b1.svcl.feign.internal.service.InventoryQueryService;
import com.sap.b1.svcl.feign.internal.service.UserDefinedObjectInternalService;
import com.sap.b1.util.HttpClientPoolUtil;
import com.sap.b1.web.core.FeignConfigSvclInterceptor;
import com.sap.b1.web.core.FeignConfigSvclInterceptorFormData;
import feign.Client;
import feign.Feign;
import feign.Logger;
...
@Configuration
public class FeignConfigSvcl {
    ServiceLayerClient client;
    @Value(value="${b1_svcl_url}")
    String svclUrl;
    @Value(value="${feign.client.config.default.loggerLevel:FULL}")
    Logger.Level logLevel;
    @Autowired
    FeignConfigSvclInterceptor interceptor;
    @Autowired
    FeignConfigSvclInterceptorFormData interceptorFormData;
    private ServiceLayerFormClient formClient;
    private ServiceLayerBatchClient batchClient;

    @Autowired
    public void init(FeignConfigSvclInterceptor interceptor, FeignConfigSvclInterceptorFormData interceptorFormData) throws Exception {
        CloseableHttpClient httpClients = HttpClientPoolUtil.buildSDKClient();
        Feign.Builder builder = Feign.builder().client((Client)new ApacheHttp5Client((HttpClient)httpClients)).logger((Logger)new Slf4jLogger()).logLevel(this.logLevel);
        builder.requestInterceptor((RequestInterceptor)interceptor);
        this.client = new ServiceLayerClient(builder, this.svclUrl + "/b1s/v1");
        builder = Feign.builder().client((Client)new ApacheHttp5Client((HttpClient)httpClients)).logger((Logger)new Slf4jLogger()).logLevel(this.logLevel);
        builder.requestInterceptor((RequestInterceptor)interceptorFormData);
        this.formClient = new ServiceLayerFormClient(builder, this.svclUrl + "/b1s/v1");
        builder = Feign.builder().client((Client)new ApacheHttp5Client((HttpClient)httpClients)).logger((Logger)new Slf4jLogger()).logLevel(this.logLevel);
        builder.requestInterceptor((RequestInterceptor)interceptor);
        this.batchClient = new ServiceLayerBatchClient(builder, this.svclUrl + "/b1s/v1");
    }
    ...
    @Bean
    ShortLinkMappings initWebClientShortLinks() {
        return (ShortLinkMappings)this.client.target(ShortLinkMappings.class);
    }
    ...
    @Bean
    UserDefinedObjectInternalService userUserDefinedObjectService() {
        return (UserDefinedObjectInternalService)this.client.target(UserDefinedObjectInternalService.class);
    }

    @Bean
    AttachmentInternalService attachmentInternalService() {
        return (AttachmentInternalService)this.formClient.target(AttachmentInternalService.class);
    }

    @Bean
    InventoryQueryService initInventoryQueryService() {
        return (InventoryQueryService)this.client.target(InventoryQueryService.class);
    }

    @Bean
    BatchInternalService initBatchInternalService() {
        return (BatchInternalService)this.batchClient.target(BatchInternalService.class);
    }
}
